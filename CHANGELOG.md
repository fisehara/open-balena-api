...
* Added build to resinci Added the no-systemd variant to resinci [Robbe Haesendonck]
* Created 2 seperate dockerfiles To allow building the no-systemd variant in parallell [Robbe Haesendonck]
* Removed systemd from container [Robbe Haesendonck]
